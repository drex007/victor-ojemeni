      ...
      <div className='container mx-auto'>
        <div>
          ...
          <div className='flex-1'>
            <h2 className='h2 text-black'>About me</h2>
            <h3 className='h3 mb-4 text-black'>I am a freelance with over 3+  years of working experience</h3>
            ...
            <div className='flex gap-x-6 lg:gap-x-10'>
              <div>
                ...
                <div className='font-primary text-sm tracking-[2px] text-black'>
